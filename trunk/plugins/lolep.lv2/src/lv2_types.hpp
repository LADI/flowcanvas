...
template<class A, class E1 = End, class E2 = End, class E3 = End, class E4 = End,
         class E5 = End, class E6 = End, class E7 = End, class E8 = End, class E9 = End>
struct MixinTree
	: E1::template I<A>
	, MixinTree<A, E2, E3, E4, E5, E6, E7, E8, E9> {
...
struct SimpleMixinTree
	: E1
	, SimpleMixinTree<A, E2, E3, E4, E5, E6, E7, E8, E9> {};


template<class A>
struct SimpleMixinTree<A, Empty, Empty, Empty, Empty, Empty, Empty, Empty, Empty, Empty> {};
